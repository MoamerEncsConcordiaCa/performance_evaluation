...
def merge_max_score(p_dir_in, p_file_in_list,  p_dir_out, p_file_out):
    ...
    with open(file_out_full, 'w') as f_out:
        for word_j in range(0,word_count):
            ...
            word_j_max_str = '{0} {1}\n'.format(word_j_max[2], word_j_max[4])
    ...
    file_out_full_sorted =  os.path.join(dir_out, 'sorted_max.txt')
...
if __name__ == '__main__':
    if len(sys.argv) > 1:
        ...
        merge_max_score(dir_in, score_file_list, dir_out, 'max_score.txt')
